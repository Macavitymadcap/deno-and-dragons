...
import { Operator, RollType } from "./dice.model.ts";
...
[
  ...
  {
    diceString: "d20+1",
    expectedRange: { min: 2, max: 21 },
    rollType: "advantage",
  },
  {
    diceString: "d20+2",
    expectedRange: { min: 3, max: 22 },
    rollType: "disadvantage",
  },
  {
    diceString: "d8-2",
    expectedRange: { min: 0, max: 14 },
    rollType: "critical",
  },
  {
    diceString: "2d10+2",
    expectedRange: { min: 6, max: 42 },
    rollType: "critical",
  },
].forEach((test) => {
...
[
  ...
  { diceString: "10d6/3", expectedModifier: 3 },
