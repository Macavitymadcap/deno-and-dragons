...
export const NPC_APPEARANCE: RollTable<string> = {
  dice: "d20",
  rows: [
  { range: 1, value: "Distinctive jewelry: earrings, necklace, circlet, bracelets"} ,
...
export const NPC_LOW_ABILITIES: RollTable<Ability> = {
  ...
  { range: 4, value: { name: "Intelligence", description: "dim-witted, slow" } },
  { range: 5, value: { name: "Wisdom", description: "oblivious, absentminded" } },
...
export const NPC_HIGH_ABILITIES: RollTable<Ability> = {
  dice: "d6",
  rows: [
  { range: 1, value: { name: "Strength", description: "powerful, brawny, strong as an ox" } },
  { range: 2, value: { name: "Dexterity", description: "lithe, agile, graceful" } },
  { range: 3, value: { name: "Constitution", description: "hardy, hale, healthy" } },
  { range: 4, value: { name: "Intelligence", description: "studious, learned, inquisitive" } },
  { range: 5, value: { name: "Wisdom", description: "perceptive, spiritual, insightful" } },
  { range: 6, value: { name: "Charisma", description: "persuasive, forceful, born leader" } },
  ]
} as const;
